...
int main(void) {
  ...
  Train trainObject({4, 0}, {-4, -4}, 0.0000006, rc1);
  Framework.addRenderObject(&trainObject);

  Train trainObject2({0, 1}, {4, -4}, 0.0000009, rc2);
  Framework.addRenderObject(&trainObject2);

  Train trainObject3({-4, 2}, {0, 2}, 0.0000012, rc3);
  Framework.addRenderObject(&trainObject3);

  Train trainObject4({4, 3}, {-4, 3}, 0.000001, rc4);
