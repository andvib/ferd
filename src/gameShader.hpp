#ifndef GAME_SHADER_HPP__
#define GAME_SHADER_HPP__
...
class GameShader
{
    ...
    public:
         ...
         *
         * @details Use this to free up space. Can safely be done after shader has been compiled.
         */
        void deleteShader();
};
